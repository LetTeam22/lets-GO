    ...
    return (
        <>
            <div className={s.container} >
                ...
                <select value='price' onChange={handlePriceSort} className={parameters.sorts.price ? `${s.orderings} ${s.act}` : s.orderings} id='priceSort'>
                    <option value=''></option>
                ...
                <select value='rating' onChange={handleRatingSort} className={parameters.sorts.rating ? `${s.orderings} ${s.act}` : s.orderings} id='ratingSort'>
                    <option value=''></option>
                ...
                <select value='name' onChange={handleNameSort} className={parameters.sorts.name ? `${s.orderings} ${s.act}` : s.orderings} id='nameSort'>
                    <option value=''></option>
