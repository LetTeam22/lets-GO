...
export default function Bookings() {
  ...
  const columnsBookings = useMemo(() => {
    return [
      ...
      { field: "status", headerName: "Status", width: 100, type: "singleSelect",
      valueOptions: ["confirmed", "cancelled"],
      editable: true },
      { field: "ernings", headerName: "Ganancias", width: 100 },
      { field: "action", headerName: "Action", type:'actions', width: 80, renderCell: (params) => <Action {...{params,rowId, setRowId, origin:'bookings'}} /> },
    ];
  }, [rowId])
